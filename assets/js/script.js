...
function MoreRespostas() {
  ...
  let resApiMore = document.getElementById('resApiDominioMore')
  let resApiMore2 = document.getElementById('resApiDominioMore2')
  let resApiMore3 = document.getElementById('resApiDominioMore3')
  let resApiMore4 = document.getElementById('resApiDominioMore4')
  let resApiMore5 = document.getElementById('resApiDominioMore5')
  let resApiMore6 = document.getElementById('resApiDominioMore6')

  let resSobreP7 = document.getElementById('sobreMore')
  let resSobreP8 = document.getElementById('sobreMore2')
  let resSobreP9 = document.getElementById('sobreMore3')
  let resSobreP10 = document.getElementById('sobreMore4')
  let resSobreP11 = document.getElementById('sobreMore5')
  let resSobreP12 = document.getElementById('sobreMore6')
  ...
  if(divRespostaMore.style.display === 'block') {
    ...
    resSobreP7.innerHTML = ""
    resSobreP8.innerHTML = ""
    resSobreP9.innerHTML = ""
    resSobreP10.innerHTML = ""
    resSobreP11.innerHTML = ""
    resSobreP12.innerHTML = ""

    resApiMore.innerHTML = ""
    resApiMore2.innerHTML = ""
    resApiMore3.innerHTML = ""
    resApiMore4.innerHTML = ""
    resApiMore5.innerHTML = ""
    resApiMore6.innerHTML = ""
    ...
    formPerguntaChat.addEventListener("submit", async (e) => {
      ...
      for (let i = 0; i < respostaElements.length; i++) {
       ...
       // console.log(` selecionado a localização ${cidade}.`);
        ...
        const usado = document.querySelector('input[name="usado"]:checked').value;
